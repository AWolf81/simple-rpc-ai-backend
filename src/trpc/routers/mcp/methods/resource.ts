  ...
  getResources: publicProcedure
    ...
    .query(({ input, ctx }) => {
      ...
      if (mcpConfig?.extensions?.resources?.customResources) {
        const customResources = mcpConfig.extensions.resources.customResources.map((resource: any) => ({
...
async function handleMCPResource(uri: string, ctx: any) {
...
async function handleCustomResource(uri: string, ctx: any) {
