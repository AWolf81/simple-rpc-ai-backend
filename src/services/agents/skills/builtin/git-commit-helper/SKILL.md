...
description: Generate descriptive commit messages by analyzing git diffs and following conventional commits. Use when the user asks for help writing commit messages or reviewing staged changes.
version: 1.0.0
...
> Source: Claude Code Templates (`development/git-commit-helper`)
