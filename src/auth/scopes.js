...
exports.DefaultScopes = exports.ScopeValidator = exports.ScopeHelpers = void 0;
exports.createMCPTool = createMCPTool;
exports.createAdminMCPTool = createAdminMCPTool;
exports.createMCPPrompt = createMCPPrompt;
/**
...
exports.ScopeHelpers = ScopeHelpers;
/**
...
function createMCPTool(config) {
    return {
        mcp: {
            ...
            ...(config.public && { scopes: exports.DefaultScopes.PUBLIC })
        }
    };
}
/**
 ...
 */
function createAdminMCPTool(config) {
 ...
 * ```
 */
function createMCPPrompt(config) {
    return {
        mcpPrompt: {
            ...config,
            // If marked as public, ensure no scope requirements
