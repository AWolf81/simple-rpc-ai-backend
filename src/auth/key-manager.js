...
exports.SimpleKeyManager = void 0;
...
class SimpleKeyManager {
    constructor(storage, validator, masterKey) {
        ...
        this.encryptionKey = (0, crypto_1.createHash)('sha256')
            .update(masterKey)
            .digest();
    }
    /**
    ...
    encryptApiKey(apiKey) {
        ...
        const nonce = (0, crypto_1.randomBytes)(12); // 96-bit nonce for GCM
...
exports.SimpleKeyManager = SimpleKeyManager;
