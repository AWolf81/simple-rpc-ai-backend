...
export class SecurityLogger {
            ...
            res.json = function (body) {
                ...
                setImmediate(async () => {
                    if (isError) {
                        ...
                        const isAuthError = (errorCode === -32001 || // Unauthorized
                        ...
                        const isValidationError = (errorCode === -32602 || // Invalid params
    ...
    async checkAutoBlock(ip) {
        ...
        const blockingEvents = recentEvents.filter(e => e.eventType === SecurityEventType.AUTH_FAILURE ||
