 ...
 */
export const DISABLED_RATE_LIMITING: MCPRateLimitConfig = {
  enabled: false,
 ...
 */
export const DISABLED_AUTH_ENFORCEMENT: AuthEnforcementConfig = {
  enabled: false,
  strictMode: false,
 ...
 */
export const DISABLED_SECURITY_LOGGING: SecurityLoggerConfig = {
  enabled: false,
  logLevel: 'error',
 ...
 */
export function shouldDisableSecurity(): boolean {
 ...
 */
export function getTestSafeConfig(config?: any) {
