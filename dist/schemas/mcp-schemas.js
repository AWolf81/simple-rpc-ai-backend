 ...
 */
export const greetingSchema = input(z.object({
 ...
 */
export const echoSchema = input(z.object({
 ...
 */
export const serverConfigSchema = defineSchema(z.object({
 ...
 */
export const toolExecutionSchema = defineSchema(z.object({
 ...
 */
export const sdkToolExecutionSchema = defineSchema(z.object({
 ...
 */
export function getMCPServiceSchemas() {
    return [
 ...
 */
export function getAllMCPSchemas() {
    return [
        ...getMCPToolSchemas(),
