...
describe.skip('MCP Router', () => {
    ...
    beforeEach(() => {
        ...
        MCPService.mockImplementation(() => mockMCPService);
        RefMCPIntegration.mockImplementation(() => mockRefIntegration);
        mockContext = {
            user: {
    ...
    describe('Ref MCP integration endpoints', () => {
        ...
        describe('searchCodeExamples', () => {
            it('should search code examples', async () => {
                ...
                expect(mockRefIntegration.searchCodeExamples).toHaveBeenCalledWith('typescript', 'async functions');
        ...
        describe('searchAPIDocumentation', () => {
            it('should search API documentation', async () => {
                ...
                expect(mockRefIntegration.searchAPIDocumentation).toHaveBeenCalledWith('fetch', 'POST');
                expect(result.success).toBe(true);
            });
        });
        describe('getGitHubDocumentation', () => {
            it('should get GitHub repository documentation', async () => {
                ...
                expect(mockRefIntegration.getGitHubDocumentation).toHaveBeenCalledWith('microsoft', 'vscode', 'README.md');
                expect(result).toEqual({
                    success: true,
                    content: '# README',
                    title: 'README'
        ...
        describe('searchLocalDocs', () => {
            it('should search local documentation', async () => {
                ...
                expect(mockRefIntegration.searchLocalDocs).toHaveBeenCalledWith('test query', '/project/path');
                expect(result.success).toBe(true);
            });
        });
