...
import { AuthEnforcer, ResourceType, createAuthEnforcementMiddleware, getDefaultAuthEnforcer, DEFAULT_AUTH_ENFORCEMENT_CONFIG } from '../../src/security/auth-enforcer.js';
import { SecurityEventType, SecuritySeverity } from '../../src/security/security-logger.js';
// Mock SecurityLogger
...
describe('AuthEnforcer', () => {
    ...
    describe('Authentication Enforcement Middleware', () => {
        ...
        it('should handle middleware errors gracefully', async () => {
            ...
            const corruptedRequest = { ...mockRequest };
