...
describe.skip('Custom Functions System (REMOVED FEATURE - FunctionRegistry and PromptManager removed)', () => {
    ...
    describe('FunctionRegistry', () => {
        ...
        it.skip('should execute custom function', async () => {
            ...
            expect(mockAIService.execute).toHaveBeenCalledWith(expect.objectContaining({
                content: 'function test() { return true; }',
        ...
        it('should validate required parameters', async () => {
            await expect(functionRegistry.executeFunction('analyzeCode', {
        ...
        it('should throw error for unknown function', async () => {
            await expect(functionRegistry.executeFunction('unknownFunction', {})).rejects.toThrow('Function \'unknownFunction\' not found');
        });
    ...
    describe('Function Parameter Validation', () => {
        it.skip('should accept valid parameters', async () => {
            ...
            await expect(functionRegistry.executeFunction('analyzeCode', params)).resolves.toBeDefined();
        });
        ...
        it.skip('should handle boolean parameters', async () => {
            ...
            await expect(functionRegistry.executeFunction('testBoolFunction', {
                content: 'test',
