...
import { RefMCPIntegration, VSCodeRefIntegration } from '../src/services/ref-mcp-integration.js';
...
describe.skip('RefMCPIntegration', () => {
    ...
    beforeEach(() => {
        ...
        refIntegration.mcpService = mockMCPService;
    });
    afterEach(() => {
        vi.resetAllMocks();
    });
    describe('initialization', () => {
        ...
        it('should verify ref tools are available after initialization', async () => {
            ...
            await refIntegration.initialize();
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Ref MCP initialized with 2 tools:'), expect.arrayContaining(['ref_search_documentation', 'ref_read_url']));
