...
import { createAdminMCPTool } from '../../../auth/scopes.js';
export function createAdminRouter(config = {}) {
    const { adminUsers = ['admin@company.com'], requireAdminAuth = true, usageAnalyticsService, virtualTokenService } = config;
    return router({
        /**
