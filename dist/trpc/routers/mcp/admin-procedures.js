...
export const adminProcedures = {
    ...
    echo: publicProcedure
        ...
        repeat: z.number().min(1).max(10).default(1).describe('Number of times to repeat the message'),
        metadata: z.record(z.any()).optional().describe('Additional metadata to include'),
    }))
        .output(z.object({
        echo: z.string(),
        repeated: z.number(),
